...
- Setup and info
  ...
  - 4MTevvuuqC2sZtckP6RPeLZcqV3JyqoF3N5fswzc3NmT is the address of the Mango v4 Program
...
- Create IDL buffer
  ...
  anchor idl write-buffer --provider.cluster $RPC_URL --provider.wallet $KEY --filepath target/idl/mango_v4_no_docs.json 4MTevvuuqC2sZtckP6RPeLZcqV3JyqoF3N5fswzc3NmT

  Save the returned address as $IDL_BUFFER

- Set IDL buffer authority

  anchor idl set-authority --provider.cluster $RPC_URL --provider.wallet $KEY --program-id 4MTevvuuqC2sZtckP6RPeLZcqV3JyqoF3N5fswzc3NmT --new-authority FP4PxqHTVzeG2c6eZd7974F9WvKUSdBeduUK3rjYyvBw $IDL_BUFFER
