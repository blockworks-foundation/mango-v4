...
use crate::state::perp::bookside_iterator::BookSideIter;

use crate::error::MangoError;
use crate::state::perp::nodes::{
...
use super::perp_market::PerpMarket;
...
impl BookSide {
    ...
    pub fn load_mut_checked<'a>(
        ...
        let state = Self::load::<BookSide>(account)?;

        match state.side_type {
            Bids => require!(account.key == &perp_market.bids, MangoError::SomeError),
            Asks => require!(account.key == &perp_market.asks, MangoError::SomeError),
        }
