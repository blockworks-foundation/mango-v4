...
async fn test_delegate() -> Result<(), TransportError> {
    ...
    //
    {
        ...
        .await
        .expect_err("Delegate should be not be able to edit the account");
    }
    ...
    //
    {
        ...
        .await
        .expect_err("Delegate should be not be able to withdraw");
    }
    ...
    //
    {
        ...
        .await
        .expect_err("Delegate should be not be able to close the account");
    }
