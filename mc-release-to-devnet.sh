...
# rg m43thNJ58XCjL798ZSq6JGAG1BnWskhdq5or6kcnfsD -l | xargs -I % sed -i '' 's/m43thNJ58XCjL798ZSq6JGAG1BnWskhdq5or6kcnfsD/m43thNJ58XCjL798ZSq6JGAG1BnWskhdq5or6kcnfsD/g' %;
...
if [[ -z "${NO_DEPLOY}" ]]; then
    # publish program
    solana --url https://mango.devnet.rpcpool.com program deploy --program-id m43thNJ58XCjL798ZSq6JGAG1BnWskhdq5or6kcnfsD -k ~/.config/solana/mango-devnet.json target/deploy/mango_v4.so
